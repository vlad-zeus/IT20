...
if (length_km !== 0) {
    if (length_km > 0) {
        if (wheel_d >= 15 && wheel_d <= 159) {
            ...
            alert(
                "Полный оборот колеса за: " +
                    wheel_length_m.toFixed(2) +
                    " метров" +
                    "\n" +
                    "Оборотов одного колеса: " +
                    wheel_turn.toFixed(2) +
                    "\n" +
                    "Оборотов четырех колес: " +
                    wheel_turn_4.toFixed(2)
            );
        } else {
            console.log(
                "Неверное значение диаметра колеса! Введите положительное число от 15 до 159!"
            );
        }
    } else {
        console.log(
            "Неверное значение километража! Введите положительное число!"
        );
    }
} else {
    console.log(
        "Неверное значение километража! Автомобиль не осуществлял движение!"
    );
}
